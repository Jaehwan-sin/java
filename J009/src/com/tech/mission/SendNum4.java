...
public class SendNum4 extends JFrame implements ActionListener {

	private JButton btn1, btn2, btn3, btn4, btnplus, btnequals, btnminus;
...
//		버튼의 텍스트를 가져오는 방법
	...
	public SendNum4() {// 화면에서의 버튼을 만드는 과정
		setTitle("SnedNum");
		setSize(300, 200);
